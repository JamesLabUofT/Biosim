...
output <- generateWeather("Gypsy_Moth_Seasonality", year-1, year, locations$KeyID, locations$Latitude, locations$Longitude, normals);
...
```{r}
library(DT)
final_dt <- DT::datatable(data = tablefinal,
